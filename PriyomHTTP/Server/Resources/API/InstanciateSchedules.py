...
class InstanciateSchedulesAPI(API):
    ...
    def handle(self, trans):
        ...
        if trans.get_request_method() == "GET":
            print >>self.out, u"Call this resource with POST to perform instanciation."
            return
        ...
        print >>self.out, u"Schedules generated until {0}".format(datetime.fromtimestamp(self.priyomInterface.now()))
